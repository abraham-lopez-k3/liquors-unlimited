            ...
            <div className="home-wine-container">
                <div className="content-row">
                    ...
                    <h3 className="red-header">37 years of service</h3>
                        <p>Opening in 1981, The Liquors Unlimited Store is enjoying many years of serving Pascagoula, MS and surrounding areas. Our liquor store proudly stocks over 4,000 different items and we can special order many more.</p>
                    </Col>
                </div>
